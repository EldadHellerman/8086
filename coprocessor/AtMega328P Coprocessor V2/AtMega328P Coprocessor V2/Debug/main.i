# 1 ".././main.c"
# 1 "C:\\Users\\Eldad\\Desktop\\folders\\hobbys\\Programing\\8086\\coprocessor\\AtMega328P Coprocessor V2\\AtMega328P Coprocessor V2\\Debug//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 ".././main.c"
# 14 ".././main.c"
...
# 1 "C:\\Program Files (x86)\\Atmel\\Studio\\7.0\\Packs\\atmel\\ATmega_DFP\\1.1.130\\include/avr/iom328p.h" 1 3
...
void init_spi(void){
 (*(volatile uint8_t *)((0x08) + 0x20)) |= (1<<0); (*(volatile uint8_t *)((0x07) + 0x20)) |= (1<<0);
 (*(volatile uint8_t *)((0x08) + 0x20)) |= (1<<1); (*(volatile uint8_t *)((0x07) + 0x20)) |= (1<<1);
 (*(volatile uint8_t *)((0x05) + 0x20)) &= ~(1<<2); (*(volatile uint8_t *)((0x04) + 0x20)) |= (1<<2);
 (*(volatile uint8_t *)((0x04) + 0x20)) |= (1<<3); (*(volatile uint8_t *)((0x04) + 0x20)) |= (1<<5); (*(volatile uint8_t *)((0x04) + 0x20)) |= (1<<2);
...
uint16_t spi(uint16_t data){
 uint16_t result;
 (*(volatile uint8_t *)((0x2E) + 0x20)) = data>>8;
 while(!((*(volatile uint8_t *)((0x2D) + 0x20)) & 0x80));
 result = (*(volatile uint8_t *)((0x2E) + 0x20));
 (*(volatile uint8_t *)((0x2E) + 0x20)) = data & 0xff;
 result <<= 8;
 while(!((*(volatile uint8_t *)((0x2D) + 0x20)) & 0x80));
 result |= (*(volatile uint8_t *)((0x2E) + 0x20));
 return(result);
...
void ad_set(uint32_t address){
 spi_send((uint16_t)address);
 (*(volatile uint8_t *)((0x05) + 0x20)) |= (1<<2); (*(volatile uint8_t *)((0x05) + 0x20)) &= ~(1<<2);
}

uint16_t ad_get(void){

 (*(volatile uint8_t *)((0x2C) + 0x20)) |= (1<<3);
 (*(volatile uint8_t *)((0x08) + 0x20)) &= ~(1<<1); (*(volatile uint8_t *)((0x08) + 0x20)) |= (1<<1);
...
void hold_bus(void){
 ...
 (*(volatile uint8_t *)((0x0A) + 0x20)) &= ~(1<<4); (*(volatile uint8_t *)((0x0B) + 0x20)) &= ~(1<<4);
 (*(volatile uint8_t *)((0x0A) + 0x20)) &= ~(1<<2); (*(volatile uint8_t *)((0x0B) + 0x20)) |= (1<<2);
 (*(volatile uint8_t *)((0x0A) + 0x20)) &= ~(1<<3); (*(volatile uint8_t *)((0x0B) + 0x20)) |= (1<<3);
...
void release_bus(void){
 (*(volatile uint8_t *)((0x0B) + 0x20)) &= ~(1<<4); (*(volatile uint8_t *)((0x0A) + 0x20)) &= ~(1<<4);
 (*(volatile uint8_t *)((0x0B) + 0x20)) |= (1<<2); (*(volatile uint8_t *)((0x0A) + 0x20)) &= ~(1<<2);
 (*(volatile uint8_t *)((0x0B) + 0x20)) |= (1<<3); (*(volatile uint8_t *)((0x0A) + 0x20)) &= ~(1<<3);
...
uint16_t read_word(uint16_t address){
 ...
 (*(volatile uint8_t *)((0x0B) + 0x20)) |= (1<<4); (*(volatile uint8_t *)((0x0B) + 0x20)) &= ~(1<<4);
 (*(volatile uint8_t *)((0x08) + 0x20)) |= (1<<0);
 (*(volatile uint8_t *)((0x0B) + 0x20)) &= ~(1<<2);
 result = ad_get();
 (*(volatile uint8_t *)((0x0B) + 0x20)) |= (1<<2);
